...
zookeeper/conf目录下修改zoo.cfg文件，确保包含以下内容
...
_--conf-file后为配置文件相对路径_

== 4.4.验证Flume-Kafka-HDFS组件是否
...
<<<<<<< HEAD
_--from-beginning_：查看该topic全部的消费信息
=======
_--from-beginning_：从topic最早的消息进行消费
>>>>>>> c49c96dd8903902291898d9807c5aa2b542fd2ae
